  ...
  var TextTruncate = function (_Component) {
    ...
    _createClass(TextTruncate, [{
      ...
      value: function getRenderText() {
        ...
        while (!calculatedStartPos && displayLine-- > 0) {
        ...
        if (!calculatedStartPos && startPos) {
          calculatedStartPos = startPos;
        }

        if (calculatedStartPos === maxTextLength) {
          return (0, _react.createElement)(textElement, props, text);
        }
        ...
        return _react2.default.createElement(
          'div',
          props,
          (0, _react.createElement)(textElement, props, text.substr(0, calculatedStartPos) + truncateText + ' '),
          textTruncateChild
        );
      }
    }, {
